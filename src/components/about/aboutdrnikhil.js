    ...
    <div className='row'>
      <div className="col-7 imgtextalign mt-5 pe-4">
          ...
          <ul>
            ...
            <li>‘Occipitocervical fusion and dysphagia. The role of head neck alignment: a case report’ published in the Journal of Clinical Orthopaedics and Trauma, 4th August, 2021.</li>
