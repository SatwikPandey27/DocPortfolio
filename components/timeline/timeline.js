...
export default function timeline() {
  return (
    <div className="section-padding pb-0" id="timeline">
          ...
          <div className="timeline">
            <div className="row g-0 justify-content-end justify-content-md-around align-items-start timeline-nodes">
              <div className="col-9 col-md-5 me-md-4 me-lg-0 order-3 order-md-1 timeline-content bg-white shadow-lg">
                <h3 className=" text-light">MBBS</h3>

                <p>
                  TD Medical College, Alleppey, Kerala
                </p>
              </div>
            ...
            <div className="row g-0 justify-content-end justify-content-md-around align-items-start timeline-nodes my-lg-5 my-4">
              <div className="col-9 col-md-5 ms-md-4 ms-lg-0 order-3 order-md-1 timeline-content bg-white shadow-lg">
                <h3 className=" text-light">USMLE</h3>

                <p>
                  Successfully completed the USMLE, a key step towards advancing an international career in medicine. 
                </p>
              </div>
            ...
            <div className="row g-0 justify-content-end justify-content-md-around align-items-start timeline-nodes">
              <div className="col-9 col-md-5 me-md-4 me-lg-0 order-3 order-md-1 timeline-content bg-white shadow-lg">
                <h3 className=" text-light">MS orthopaedics</h3>

                <p>
                  GMC Kota, Rajasthan
                  Earned an MS in Orthopaedics from GMC Kota.
                </p>
              </div>
            ...
            <div className="row g-0 justify-content-end justify-content-md-around align-items-start timeline-nodes my-lg-5 my-4">
              <div className="col-9 col-md-5 ms-md-4 ms-lg-0 order-3 order-md-1 timeline-content bg-white shadow-lg">
                <h3 className=" text-light">FNB Spine Surgery</h3>
              ...
              <div className="col-3 col-sm-1 order-2 timeline-icons text-md-center">
                <i className="bi-clipboard2-pulse-fill timeline-icon"></i>
              </div>
            ...
            <div className="row g-0 justify-content-end justify-content-md-around align-items-start timeline-nodes my-lg-5 my-4">
              <div className="col-9 col-md-5 ms-md-4 ms-lg-0 order-3 order-md-1 timeline-content bg-white shadow-lg">
                <h3 className=" text-light">Best FNB Ravi K. Jerath Award</h3>

                <p>
                  Sir Ganga Ram Hospital, New Delhi
                  Recognized for exceptional work in spine surgery with this prestigious award.
                </p>
              </div>

              <div className="col-3 col-sm-1 order-2 timeline-icons text-md-center">
                <i className="bi-award-fill timeline-icon"></i>
              </div>
            ...
            <div className="row g-0 justify-content-end justify-content-md-around align-items-start timeline-nodes">
              <div className="col-9 col-md-5 me-md-4 me-lg-0 order-3 order-md-1 timeline-content bg-white shadow-lg">
                <h3 className=" text-light">Asscociate Consultant Spine Surgery</h3>

                <p>
                  Asscociate Consultant Spine Surgery, Jaypee Hospital, Noida
                </p>
              </div>

              <div className="col-3 col-sm-1 order-2 timeline-icons text-md-center">
                <i className="bi-hospital timeline-icon"></i>
              </div>

              <div className="col-9 col-md-5 ps-md-3 ps-lg-0 order-1 order-md-3 py-4 timeline-date">
                <time>Nov 2019 -Dec, 2020</time>
              </div>
            </div>

            <div className="row g-0 justify-content-end justify-content-md-around align-items-start timeline-nodes my-lg-5 my-4">
              <div className="col-9 col-md-5 ms-md-4 ms-lg-0 order-3 order-md-1 timeline-content bg-white shadow-lg">
                <h3 className=" text-light">Consultant Spine surgery</h3>
              ...
              <div className="col-9 col-md-5 pe-md-3 pe-lg-0 order-1 order-md-3 py-4 timeline-date">
                <time>Jan - Sep, 2021</time>
              </div>
            </div>

            <div className="row g-0 justify-content-end justify-content-md-around align-items-start timeline-nodes my-lg-5 my-4">
              <div className="col-9 col-md-5 ms-md-4 ms-lg-0 order-3 order-md-1 timeline-content bg-white shadow-lg">
                <h3 className=" text-light">Complex spine fellowship</h3>
              ...
              <div className="col-3 col-sm-1 order-2 timeline-icons text-md-center">
                <i className="bi-journal-medical timeline-icon"></i>
              </div>
            ...
            <div className="row g-0 justify-content-end justify-content-md-around align-items-start timeline-nodes my-lg-5 my-4">
              <div className="col-9 col-md-5 ms-md-4 ms-lg-0 order-3 order-md-1 timeline-content bg-white shadow-lg">
                <h3 className=" text-light">Advanced Spine fellowship</h3>
              ...
              <div className="col-9 col-md-5 pe-md-3 pe-lg-0 order-1 order-md-3 py-4 timeline-date">
                <time>Sep 2021- August 2024 </time>
              </div>
            </div>
